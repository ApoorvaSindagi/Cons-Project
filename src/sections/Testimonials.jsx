  ...
  return (
    ...
    <motion.div
      ...
      <motion.h1 variants={slideUpVariants} className='text-yellow-400
        text-2xl'>TESTIMONIALS</motion.h1>
        <motion.div
        variants={slideUpVariants}
        className="text-white uppercase text-[40px] font-bold text-center">WHAT OUR CLIENTS SAY</motion.div>
        <motion.div
        variants={slideUpVariants}
        ...
        items-start gap-[20px] mt-[30px]'>
          {
            clients.map((item,index) => (
              <div key={index} className='flex flex-col justify-center items-center'>
                <div className='border-2 border-white hover:bg-yellow-400 pb-[100px]
                pt-[30px]'>
                ...
                <div className='flex flex-col justify-center items-center gap-[5px]'>
                  ...
                  <h1 className='text-yellow-400 text-[22px]'>{item.post}</h1>
                </div>
              </div>
            ))
          }
