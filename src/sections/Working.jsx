  ...
  return (
    ...
    <motion.div
      ...
      <motion.h1 variants={slideUpVariants} className='text-yellow-400
        text-2xl'>STEP BY STEP</motion.h1>
        <motion.div
        variants={slideUpVariants}
        className="text-black uppercase text-[40px] font-bold text-center">HOW IT'S WORKING</motion.div>
        <motion.div
        variants={slideUpVariants}
        ...
        items-start gap-[20px] mt-[30px]'>
          {
           planning.map((item,index) => (
            ...
            gap-5 border-2 border-yellow-400 rounded-mg p-6'>
              <div>
                <item.icon className='size-[80px] bg-yellow-400 hover:bg-black
